...
if(isset($_POST['connexion_inscription'])){ //afficher le formulaire d'inscription ou de connexion
...
if(isset($_POST['inscription'])){ //traite le formulaire d'inscription
	$loginok = true;
	$mdpok = false;

	//traitement login existe pas encore
